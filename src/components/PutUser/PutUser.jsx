...
{/* 
    ...
    ThirdPrize: '', */}
              ...
              <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center',}}>
                <div className="block">
                  <Label htmlFor="salesCommissionPercentage" value="salesCommissionPercentage" />
                </div>
                <TextInput
                  style={{
                    paddingLeft: '0.5rem',
                  ...
                  onChange={(event) =>
                    handleInputChange('salesCommissionPercentage', event.target.value)
                  }
                  required
                />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center',}}>
                <div className="block">
                  <Label htmlFor="paymentCommissionPercentage" value="paymentCommissionPercentage" />
                </div>
                <TextInput
                  style={{
                    paddingLeft: '0.5rem',
                  ...
                  onChange={(event) =>
                    handleInputChange('paymentCommissionPercentage', event.target.value)
                  }
                  required
                />
              </div>
