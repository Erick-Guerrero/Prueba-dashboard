...
function DialogClient({ open1, onClose1 }) {
  ...
  return (
    <>
   <Modal dismissible show={open1} isOpen={open1} size="5xl" onClose={onClose1} popup style={{   display: "flex",justifyContent: "center", alignItems: "center", top: 0, left: 0, width: "100%", height: "100%",}}>
                                ...
                                <tbody>
                                  <tr>
                                    {ticket.TicketNumbers.map((numberInfo, index) => (
                                      <td style={{ border: "1px solid #0e8a7181",width:"50px" }} key={index}>
                            ...
                            <td>
                              <table style={{ display: "flex", justifyContent: "center" }}>
                                <tbody>
                                  <tr>
                                    {ticket.TicketNumbers.map((numberInfo, index) => (
                                      <td style={{ border: "1px solid #0e8a7181",width:"70px" }} key={index}>
                                        S/{numberInfo.bet}
                                      </td>
                                    ))}
                                  </tr>
